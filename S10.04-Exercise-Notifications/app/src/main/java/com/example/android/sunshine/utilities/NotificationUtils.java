...
//  TODO (COMPLETE) (1) Create a constant int value to identify the notification
...
//          TODO (COMPLETE) (2) Use NotificationCompat.Builder to begin building the notification
...
//          TODO (COMPLETE) (3) Create an Intent with the proper URI to start the DetailActivity
            Intent detailIntentForToday = new Intent(context, DetailActivity.class);
            detailIntentForToday.setData(todaysWeatherUri);


//          TODO (COMPLETE) (4) Use TaskStackBuilder to create the proper PendingIntent
...
//          TODO (COMPLETE) (5) Set the content Intent of the NotificationBuilder
            notificationBuilder.setContentIntent(resultPendingIntent);

//          TODO (COMPLETE) (6) Get a reference to the NotificationManager
            NotificationManager notificationManager = (NotificationManager)
                    context.getSystemService(Context.NOTIFICATION_SERVICE);


//          TODO (COMPLETE) (7) Notify the user with the ID WEATHER_NOTIFICATION_ID
            notificationManager.notify(WEATHER_NOTIFICATION_ID, notificationBuilder.build());

//          TODO (COMPLETE) (8) Save the time at which the notification occurred using SunshinePreferences
