...
//      TODO (COMPLETE) (7) Replace the single TextView with Views to display all of the weather info
...
//      TODO (COMPLETE) (4) Replace the weatherSummary TextView with individual weather detail TextViews
...
//      TODO (COMPLETE) (5) Add an ImageView for the weather icon
        final ImageView iconView;

        ForecastAdapterViewHolder(View view) {
            super(view);

//          TODO (COMPLETE) (6) Get references to all new views and delete this line
